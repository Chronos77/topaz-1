...
RUN apt update && apt install -y net-tools nano build-essential software-properties-common libzmq3-dev luarocks cmake pkg-config dnsutils git mariadb-server libluajit-5.1-dev libzmq3-dev autoconf pkg-config zlib1g-dev libssl-dev libmariadb-dev-compat
